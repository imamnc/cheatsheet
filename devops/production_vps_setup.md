...
1. [🐳 Docker Setup](#1-setup-docker)
2. [🔄 GitLab Runner](#2-setup-gitlab-runner)
3. [🔑 SSH Configuration](#3-generate-ssh-key-optional)
4. [🔥 UFW Firewall](#4-ufw-uncomplicated-firewall)
5. [🛡️ fail2ban Protection](#5-fail2ban--basic-setup)
